    ...
    def build(
        ...
        *,
        ...
        return (
            ...
            f"Required Response Language: {agent.language}\n\n"
            ...
            "- You MUST answer in the agent's required response language unless the user explicitly asks to switch languages.\n"
            ...
            "========================\n"
            "- Never force one fixed template for every answer.\n"
            ...
            "- For code/debugging, explain briefly, then provide code or concrete steps in proper fenced code blocks when useful.\n"
            ...
            "- If the question is small, keep the answer small.\n"
            "- If the question is deep, make the answer detailed.\n"
            ...
            "   - Include:\n"
            "      the main chat topic or user intent in clear title-friendly wording\n"
            "      agent role used\n"
            "      memory used (if any)\n"
            "      response style applied\n\n"
            "   - Start with the actual topic, not generic wording like 'The user asked' or 'The agent handled'\n"
            "   - Make it suitable for deriving a concise chat title\n\n"
            "2. response:\n"
